...
/// 
//////////////////////////////////////////////////////////////////////////
class LightBaseBehavior : public Component
{
...
class LightBaseBehaviorInstance : public ComponentInstance, public ISceneLight
{
...
public:
   LightBaseBehaviorInstance(Component *btemplate = NULL);
