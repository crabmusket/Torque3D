...
#include "component/components/Light/spotLightBehavior.h"
...
//////////////////////////////////////////////////////////////////////////
ComponentInstance *SpotLightBehavior::createInstance()
{
...
//==========================================================================================
//==========================================================================================
SpotLightBehaviorInstance::SpotLightBehaviorInstance( Component *btemplate ) 
{
   mRange = 10.0f;
...
void SpotLightBehaviorInstance::onComponentAdd()
{
   Parent::onComponentAdd();
}

void SpotLightBehaviorInstance::onComponentRemove()
{
...
{
   /*mLight->setTransform( mOwner->getTransform() );
...
void SpotLightBehaviorInstance::_renderViz( SceneRenderState *state )
{
   ...
   F32 radius = mRange * mSin( mDegToRad( mOuterConeAngle * 0.5f ) );
   draw->drawCone(   desc, 
      mOwner->getPosition() + ( mOwner->getTransform().getForwardVector() * mRange ),
      mOwner->getPosition(),
      radius,
      color );
}