...
//////////////////////////////////////////////////////////////////////////
ComponentInstance *LightBaseBehavior::createInstance()
{
...
//==========================================================================================
//==========================================================================================
LightBaseBehaviorInstance::LightBaseBehaviorInstance( Component *btemplate ) 
{
   mTemplate = btemplate;
   mOwner = NULL;
...
void LightBaseBehaviorInstance::onComponentAdd()
{
   Parent::onComponentAdd();
}

void LightBaseBehaviorInstance::onComponentRemove()
{
...
void LightBaseBehaviorInstance::submitLights( LightManager *lm, bool staticLighting )
{
      ...
      mAnimationData )
   {
      ...
      mAnimState.transform = mOwner->getRenderTransform();
...
void LightBaseBehaviorInstance::prepRenderImage( SceneRenderState *state )
{
   if ( mIsEnabled && mFlareData )
   {
      ...
      mFlareState.lightMat = mOwner->getRenderTransform();
