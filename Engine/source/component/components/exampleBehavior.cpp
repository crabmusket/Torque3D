...
#include "component/components/exampleBehavior.h"
...
//////////////////////////////////////////////////////////////////////////
ComponentInstance *ExampleBehavior::createInstance()
{
...
//==========================================================================================
//==========================================================================================
ExampleBehaviorInstance::ExampleBehaviorInstance( Component *btemplate ) 
{
   mTemplate = btemplate;
   mOwner = NULL;
...
void ExampleBehaviorInstance::onComponentAdd()
{
   Parent::onComponentAdd();
}

void ExampleBehaviorInstance::onComponentRemove()
{
