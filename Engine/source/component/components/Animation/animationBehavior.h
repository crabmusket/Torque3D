...
class AnimationBehaviorInstance : public ComponentInstance
{
...
public:
   AnimationBehaviorInstance(Component *btemplate = NULL);
   ...
   //callbacks
   DECLARE_CALLBACK( void, onAnimationStart, ( ComponentInstance* obj, const String& animName ) );
   DECLARE_CALLBACK( void, onAnimationEnd, ( ComponentInstance* obj, const char* animName ) );
   DECLARE_CALLBACK( void, onAnimationTrigger, ( ComponentInstance* obj, const String& animName, S32 triggerID ) );
};
