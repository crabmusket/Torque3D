...
#include "component/components/Animation/AnimationBehavior.h"
...
// Callbacks
//////////////////////////////////////////////////////////////////////////
IMPLEMENT_CALLBACK( AnimationBehaviorInstance, onAnimationStart, void, ( ComponentInstance* obj, const String& animName ), ( obj, animName ),
...
IMPLEMENT_CALLBACK( AnimationBehaviorInstance, onAnimationEnd, void, ( ComponentInstance* obj, const char* animName ), ( obj, animName ),
                   "@brief Called when we collide with another object.\n\n"
                   "@param obj The ShapeBase object\n"
                   "@param collObj The object we collided with\n"
                   "@param vec Collision impact vector\n"
...
IMPLEMENT_CALLBACK( AnimationBehaviorInstance, onAnimationTrigger, void, ( ComponentInstance* obj, const String& animName, S32 triggerID ), ( obj, animName, triggerID ),
                   "@brief Called when we collide with another object.\n\n"
                   "@param obj The ShapeBase object\n"
                   "@param collObj The object we collided with\n"
                   "@param vec Collision impact vector\n"
...
//////////////////////////////////////////////////////////////////////////
ComponentInstance *AnimationBehavior::createInstance()
{
...
//==========================================================================================
//==========================================================================================
AnimationBehaviorInstance::AnimationBehaviorInstance( Component *btemplate ) 
{
   mTemplate = btemplate;
   mOwner = NULL;
...
void AnimationBehaviorInstance::onComponentAdd()
{
   Parent::onComponentAdd();
}

void AnimationBehaviorInstance::onComponentRemove()
{
   ...
   for (U32 i = 0; i < MaxScriptThreads; i++) 
   {
      ...
      if (st.thread) 
      {
            ...
            shapeInstance->getPos(st.thread) <= 0)) 
         {
            ...
            ((Entity*)mOwner)->pushEvent("animationEnd", arg);
         }
         ...
         {  
            ...
            {  
               ...
               {  
                  ...
                  arg.push_back(st.thread->getSequenceName());
                  //TODO: add trigger ID
                  ((Entity*)mOwner)->pushEvent("animationTrigger", arg);
               }  
            }  
         }
      }
