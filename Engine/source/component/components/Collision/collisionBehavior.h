...
class CollisionBehavior : public Component
{
...
class CollisionBehaviorInstance : public ComponentInstance,
...
public:
   ...
   CollisionBehaviorInstance(Component *btemplate = NULL);
   ...
   //Callbacks
   DECLARE_CALLBACK( void, onCollision, ( ComponentInstance* obj, SceneObject* collObj, VectorF vec, F32 len ) );
   DECLARE_CALLBACK( void, onRaycastCollision, ( ComponentInstance* obj, SceneObject* collObj, Point3F pos, Point3F normal ) );
   DECLARE_CALLBACK( void, onContact, ( ComponentInstance* obj, SceneObject* collObj ) );
};
